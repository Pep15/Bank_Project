...
private:
    enum enTransactionsMenueOptions {
        ...
        eShowTotalBalance = 3, eTransfer = 4 , eTransferLogs ,eShowMainMenue = 6
    };
    static short ReadTransactionsMenueOption()
    {
        cout << setw(37) << left << "" << "Choose what do you want to do? [1 to 6]? ";
        short Choice = clsInputValidate<int>::ReadNumberBetween(1, 6, "Enter Number between 1 to 4? ");
        return Choice;
    }
    ...
    {
       // clsTransfer::ShowScreenClinetsTransfer();
